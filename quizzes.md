...
## 📅 Week 2 — Excel + Tableau
**Day 6 (Nov 3)** — Excel Formulas & Functions  
🎯 [Quiz + Review →](https://docs.google.com/)  

**Day 7 (Nov 4)** — Pivot Tables & Conditional Formatting  
🎯 [Quiz + Review →](https://docs.google.com/)  

**Day 8 (Nov 5)** — Cleaning Data in Excel  
🎯 [Quiz + Review →](https://docs.google.com/)  

**Day 9 (Nov 6)** — Tableau Setup & Visualizations  
🎯 [Quiz + Review →](https://docs.google.com/)  

**Day 10 (Nov 7)** — Tableau Beginner Project  
🎯 [Quiz + Review →](https://docs.google.com/)  

---

## 📅 Week 3 — Power BI + Python Basics
**Day 11 (Nov 10)** — Power BI Setup & Queries  
🎯 [Quiz + Review →](https://docs.google.com/)  

**Day 12 (Nov 11)** — DAX, Drilldowns & Formatting  
🎯 [Quiz + Review →](https://docs.google.com/)  

**Day 13 (Nov 12)** — Python Installation & Variables  
🎯 [Quiz + Review →](https://docs.google.com/)  

**Day 14 (Nov 13)** — Loops & Functions in Python  
🎯 [Quiz + Review →](https://docs.google.com/)  

**Day 15 (Nov 14)** — File Handling & Mini Projects  
🎯 [Quiz + Review →](https://docs.google.com/)  

---

## 📅 Week 4 — Python Advanced + Portfolio
**Day 16 (Nov 17)** — Web Scraping & BeautifulSoup  
🎯 [Quiz + Review →](https://docs.google.com/)  

**Day 17 (Nov 18)** — Pandas Data Cleaning & EDA  
🎯 [Quiz + Review →](https://docs.google.com/)  

**Day 18 (Nov 19)** — AWS + Azure Basics  
🎯 [Quiz + Review →](https://docs.google.com/)  

**Day 19 (Nov 20)** — Portfolio & Resume Setup  
🎯 [Quiz + Review →](https://docs.google.com/)  
